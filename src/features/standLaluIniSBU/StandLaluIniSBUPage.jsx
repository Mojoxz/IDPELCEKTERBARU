          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {processedData && (
              <div className="bg-green-50 rounded-xl p-6 border border-green-200 animate-slide-up">
                ...
                <p className="text-gray-600 mb-4">
                  {processedData.data.length} baris dengan nilai berbeda di kolom STAND LALU dan STAND INI
                </p>
                <button
            ...
            <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                ...
                <li className="flex items-start">
                  <span className="text-amber-500 mr-2">•</span>
                  Kolom STAND LALU dan STAND INI harus ada di sheet yang dipilih
                </li>
                <li className="flex items-start">
                  <span className="text-amber-500 mr-2">•</span>
            ...
            {processedData && (
              <div className="bg-white rounded-xl shadow-sm overflow-hidden animate-slide-up">
                ...
                <div className="p-6">
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {processedData.data.slice(0, 100).map((row, rowIdx) => (
                  ...
                  {processedData.data.length > 100 && (
                    <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                      <p className="text-sm text-blue-700">
                        Menampilkan 100 dari {processedData.data.length} baris. 
